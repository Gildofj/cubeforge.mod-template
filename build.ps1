<#
.SYNOPSIS
    CubeForge Mod Template Build Script (MSVC x64) - CMake Presets Automation
.DESCRIPTION
    Script de automação para compilação unificada do mod com MSVC x64 e instalação automática.
...
Write-Host "==> Compilando mod..." -ForegroundColor Cyan
